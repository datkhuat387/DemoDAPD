package com.example.demodapd.ui.user.fragment.order;
...
import com.example.demodapd.adapter.BillAdapter;
...
public class OrderConfimFragment extends Fragment {

    private RecyclerView rcv_confirm;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_order_confim, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rcv_confirm = view.findViewById(R.id.rcv_order_confirm);
        ...
        rcv_confirm.setLayoutManager(new LinearLayoutManager(getActivity()));
        rcv_confirm.setAdapter(billAdapter);
        fetchBill(id);
    }
